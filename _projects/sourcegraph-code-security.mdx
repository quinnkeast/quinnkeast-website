...
<figure className="bg-white p-4">
  <img src="/assets/projects/code-security-low-fidelity.png" />
</figure>
...
<figure>
  ...
  <img src="/assets/projects/code-security-search-results.png" />
  </div>
  <figcaption>Our most promising direction that we began building into the product involved surfacing dependencies as a type of search result.</figcaption>
</figure>
