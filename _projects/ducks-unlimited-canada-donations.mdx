...
<div class="grid grid-cols-3 max-w-lg mx-auto">
	<div>
		<p>
			<span class="text-4xl font-bold">118%</span><br />
			<span class="text-black-lighter">more donations</span>
		</p>
	</div>
	<div>
		<p>
			<span class="text-4xl font-bold">153%</span><br />
			<span class="text-black-lighter">increase in donation revenue</span>
		</p>
	</div>
	<div>
		<p>
			<span class="text-4xl font-bold">14%</span><br />
			<span class="text-black-lighter">increase in average donation amount</span>
		</p>
	</div>
</div>
