...
- Captured these in a design challenge and collaborated with engineers on the team to propose a new feature: Code monitoring.

import GDoc from "../components/gdoc.jsx";

<div className="max-w-lg mx-auto">
  <GDoc
	link="https://docs.google.com/document/d/1_R5DgpUkxyZilsJ9vBQm5cvRPT2udc3tZIPg2q3cnZU/edit#"
