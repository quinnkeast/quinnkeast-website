  ...
  return (
    <>
      <div className="grid md:hidden pt-4">
        <Link href="/">
          <a className="font-medium border-0 text-sm mb-2">Quinn Keast</a>
        </Link>
        <div className="col-2">
          <menu className="flex flex-wrap gap-x-2 gap-y-0 list-none px-0 my-0 text-black-lighter text-sm">
