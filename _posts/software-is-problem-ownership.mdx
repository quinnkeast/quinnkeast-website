...
It’s paying for someone who has the taste and the context to think through the details. For the operations and structures necessary to scale it, maintain it, and solve even bigger things.<sup>1</sup> For the relationships that connect and abstract and expand upon the problem in ways that they can’t do, because they own the specific solution, not the whole problem.
