...
**High atomicity** opportunities are self-contained or adaptable. The solutions generalize well and remain valuable even as the product evolves, and either support or unlock further evolution. For example: a new, well-designed API is creates a stable interface that will remain valuable as the product evolves.
