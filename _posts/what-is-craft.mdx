...
ogImage:
  url: "/assets/writing/ivo-daskalov--4RpLg7CA8c-unsplash-lg.jpeg"
published: true
minimal: true
tags:
  - design
...
<div className="rounded inline-block bg-white py-2 px-2">
    <p className="m-0 text-sm italic">FYI—This is a stub of an idea I’ll build on over time.</p>
</div>
