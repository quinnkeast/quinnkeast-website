...
subtitle: "An easy four-step process to writing quickly and easily"
date: "2022-01-29"
author:
  name: Quinn Keast
...
None of this is to say you shouldn’t try new things (unless you're G.R.R. Martin, who famously continues to write in WordStar 4.0, released in 1987, on a DOS-based machine*). Experiment with your publishing channels and writing tools and try new things—but do this separate from when you intend to _write_, or it’ll lull you into a false sense of productivity that ends up with not actually _writing anything_.


_\* At this point, maybe it’s time for him to try something new..._
